<div align="center">
  ...
  <p>
    ...
    ·
    <a href="./docs/CHANGELOG.md">更新日志 v1.0.1 → v1.2.18</a>
    ·
    <a href="#-快速开始">快速开始</a>
    ·
  ...
  <p>
    ...
    <img alt="Version" src="https://img.shields.io/badge/version-1.2.18-30d158?style=for-the-badge" />
  </p>
</div>
...
- 登录后获取收藏夹列表
- 导入收藏夹到本地
- 双向同步：本地收藏 ↔ B站收藏夹（启动与每 2 分钟自动同步，变更时即时同步）
- 批量下载收藏夹内容
- 导出收藏夹为本地歌单
- 曲目可收藏至 B站收藏夹（aid 缺失时自动通过 bvid 解析，已收藏的收藏夹默认勾选，可一键取消收藏）
- 收藏夹内容行支持「×」一键移除
- 自动同步：登录后启动时 + 每 2 分钟自动执行「导入本地 + 双向同步」
